        ...
        <div class="w-full md:w-1/2 flex flex-col">
            ...
            <div class="flex flex-col justify-center md:justify-start my-auto pt-8 md:pt-0 px-8 md:px-24 lg:px-32">
                ...
                <div class="text-center pt-12 pb-12">
                    <p>Already have an account? <nuxt-link to="/login" class="underline font-semibold">Log in here.</nuxt-link></p>
                </div>
            </div>
        </div>
        <!-- Image Section -->
        <div class="w-1/2 shadow-2xl">
            <img class="object-cover w-full h-screen hidden md:block" src="../assets/img/clothes-7.jpeg">
        </div>
    </div>
  </body>
</template>